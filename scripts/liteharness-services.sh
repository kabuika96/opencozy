...
labels=("com.liteharness.backend.dev" "com.liteharness.frontend.dev")
...
service_for_label() {
  case "$1" in
    com.liteharness.backend.dev)
      echo "backend"
      ;;
    com.liteharness.frontend.dev)
      echo "frontend"
      ;;
    *)
      return 64
...
configured_port_for_service() {
  case "$1" in
    backend)
      configured_value "LITEHARNESS_BACKEND_PORT" "8787"
      ;;
    frontend)
      configured_value "LITEHARNESS_FRONTEND_PORT" "5173"
      ;;
    *)
      return 64
      ;;
...
<dict>
  ...
  <array>
    <string>$root/scripts/liteharness-service-runner.sh</string>
  ...
  <dict>
    <key>LITEHARNESS_SERVICE_LOG_DIR</key>
